...
void main()
{
    Out.Color = vec4(pow(aColor.rgb, vec3(2.2)), aColor.a); // MODIFIED
    Out.UV = aUV;
...
#endif
    const VkFormat defaultFormats[] = { VK_FORMAT_B8G8R8A8_SRGB, VK_FORMAT_R8G8B8A8_SRGB, VK_FORMAT_B8G8R8_SRGB, VK_FORMAT_R8G8B8_SRGB };
