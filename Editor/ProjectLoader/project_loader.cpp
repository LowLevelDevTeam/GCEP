...
namespace pl
{
    ...
    std::string project_loader::nowISO8601()
    {
    ...
    void project_loader::loadProject(const std::filesystem::path& projFile)
    {
    ...
    void project_loader::writeProjectFile()
    {
        ...
        addString(d, "start_scene", std::filesystem::relative(
                                        m_info.startScene, m_info.projectPath).string());
    ...
    void project_loader::saveProject() { writeProjectFile(); }

    project_loader & project_loader::instance()
    {
        static project_loader inst;
        return inst;
    }

    void project_loader::init(GLFWwindow *window)
    {
        m_window = window;
    }

    void project_loader::update(double deltaTime)
    {
